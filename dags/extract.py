        ...
        if response.status_code == 200:
            ...
            with zipfile.ZipFile(zip_bytes) as zip_file:
                ...
                with zip_file.open(csv_name) as csv_file:
                    ...
                    df = pd.read_csv(csv_file, sep=',', encoding='latin1', dtype=dtype_dict)
                    df_pe = df[df['SG_UF_NOT'] == 26]
            ...
            # Substitui ou cria a tabela 'dengue.pe'
            conn.execute("CREATE TABLE IF NOT EXISTS dengue.dengue_pe AS SELECT * FROM df_pe")
